...
public class SettingsActivity extends AppCompatActivity {
    ...
    private TextView profileImageChangeTextBtn, closeTextBtn, saveTextBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileImageChangeTextBtn = (TextView) findViewById(R.id.profile_image_change_btn);
        ...
        profileImageChangeTextBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void updateOnlyUserInfo() {
        ...
        Toast.makeText(SettingsActivity.this, "Profile/Account Information Updated Successfully", Toast.LENGTH_SHORT).show();
        finish();
    ...
    private void uploadImageAndUserInfo() {
        ...
        if(imageUri != null){
            ...
            .addOnCompleteListener(new OnCompleteListener<Uri>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(SettingsActivity.this, "Error is: "+ e, Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void userInfoDisplay(final CircleImageView profileImageView, final EditText fullNameEditText,
                                 ...
                                 final EditText userPasswordEditText) {
