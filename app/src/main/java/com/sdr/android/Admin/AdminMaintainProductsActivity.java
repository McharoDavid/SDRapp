...
public class AdminMaintainProductsActivity extends AppCompatActivity {
    ...
    private void applyChanges() {
        ...
        String pPrice1 = price.getText().toString();
        String pDescription1 = description.getText().toString();
        ...
        if(pName1.equals("")){
        ...
        else if(pPrice1.equals("")){

            Toast.makeText(this, "Please Write Product Price.", Toast.LENGTH_SHORT).show();

        }
        else if(pDescription1.equals("")){
            ...
            productMap.put("description", pDescription1);
            productMap.put("price", pPrice1);
